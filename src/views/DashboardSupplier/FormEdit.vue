<template>
  <div class="body">
    ...
    <div class="container">
      <div class="card">
        <div class="card-header blue-sky"><h2>Update Supplier</h2></div>
        <div class="card-body">
          <form>
            ...
            <div class="form-group">
              <label class="form-label">No Tlp Supplier</label>
              <input
                type="tel"
                class="form-control"
            ...
            <div class="card-footer">
              ...
              <button type="button" class="btn btn-primary" @click="updateSupplier">Simpan</button>
            </div>
          </form>
        </div>
      </div>
